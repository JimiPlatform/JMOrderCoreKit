...
/// @param handler 回调
- (void)startRecord:(NSString *)fileName handler:(void (^_Nonnull)(JM_MEDIA_RECORD_STATUS status, NSString *filePath, JMError *_Nullable error))handler;
...
/// 开始对讲
/// @param handler 回调
- (void)startTalk:(void (^ _Nonnull)(JM_MEDIA_TALK_STATUS status, JMError *_Nullable error))handler;
